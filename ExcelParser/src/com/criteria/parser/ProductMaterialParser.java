...
import com.a4.product.beans.BlendMaterial;
...
public class ProductMaterialParser {
	            ...
	            if(index==-1 &&!isCombo &&!isBlendValue){
	               ...
	               String mtrlArray[]=value.split(ApplicationConstants.CONST_DELIMITER_COLON);
	                ...
	                if (indexAlias != -1) {
	                 ...
	                 int comboIndex=tempValue.indexOf(CONST_STRING_COMBO_TEXT);
	...
	private boolean isComboMaterial(String value) {
    	...
    	if(value.contains(COMBO_VALUES_SEPARATOR)) {
    		...
    		result = (comboValues.length % 2 == 1) && comboValues[COMBO_TEXT_VALUE_INDEX].equalsIgnoreCase( CONST_STRING_COMBO_TEXT);
    	}
    	return result;
}
	...
	private boolean isBlendMaterial(String value) {
    	...
    	if(value.contains(CONST_STRING_BLEND_TEXT)){
    		result=true;
    	}
    	return result;
   }   
